            ...
            return this.each(function() {
                    ...
                    $(link).on("click", function(e) {
                        ...
                        if ($target.length > 0) {
                            ...
                            options.animate ? $("html, body").animate({
                                scrollTop: top
                            }, options.duration) : window.scrollTo(0, top),
                            e.preventDefault()
                        }
                    })
                }
                ...
                var elements = findElements(links)
                  , trackChanged = function() {
                    for (var link, position = {
                        ...
                        if (position.top >= current.top && position.top < current.bottom) {
                            ...
                            if (link = findLink(links, hash)) {
                                options.onChange && scrollArea !== hash && (options.onChange(current.element, $(element), position),
                                scrollArea = hash),
                                options.replaceState && history.replaceState({}, "", "/" + hash),
                                resetClasses(links),
                    ...
                    !link && "exit" !== scrollArea && options.onExit && (options.onExit($(element), position),
                    resetClasses(links),
                    scrollArea = "exit",
